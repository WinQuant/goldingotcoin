...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Jincoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"seedjincoin", "seed.jincoin.net"},
    {"seed", "seed.jcoin.net"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"tseedjincoin", "tseed.jincoin.net"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Jincoin is probably already running."), addrBind.ToString().c_str());
        else
