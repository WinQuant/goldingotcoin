...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("JC");
    case mBTC: return QString("mJC");
    case uBTC: return QString::fromUtf8("μJC");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Jincoins");
    case mBTC: return QString("Milli-Jincoins (1 / 1,000)");
    case uBTC: return QString("Micro-Jincoins (1 / 1,000,000)");
    default: return QString("???");
    }
}
