...
// jcoin: sync-checkpoint master key
...
// jcoin: synchronized checkpoint (centrally broadcasted)
...
// jcoin: get last synchronized checkpoint
...
// jcoin: only descendant of current sync-checkpoint is allowed
...
// jcoin: reset synchronized checkpoint to last hardened checkpoint
...
// jcoin: find block wanted by given orphan block
...
// jcoin: verify signature of sync-checkpoint message
...
// jcoin: process synchronized checkpoint
...
// get information of sync-checkpoint (first introduced in jcoin)
